...
export default {
  ...
  computed: {
    ...mapState(useTodoStore, ["list"]),
    ...mapState(useActivityStore, ["byId"]),
  },
  methods: {
    ...mapActions(useTodoStore, ["getListTodo"]),
  ...
  created() {
    ...
    this.getListTodo(this.$route.params.id);
...
<template>
  <div class="py-10 px-5 mx-auto sm:max-w-5xl">
    <div class="flex justify-between items-center w-full">
      <div class="flex justify-start items-center w-[75%]">
        <button
          @click="
            () => {
              $router.push('/');
      ...
      >
        ...
        <p v-if="window.width > 640">Tambah</p>
      </button>
    </div>
    <div class="flex justify-center items-center mt-10 w-full">
      <svg
        class="w-full sm:w-[36rem] mx-auto"
        viewBox="0 0 767 490"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      ...
      >
        <g clip-path="url(#clip0_2_477)">
          ...
          <path
            d="M220.592 179.122C219.917 178.057 219.029 177.15 217.986 176.46C216.943 175.77 215.769 175.313 214.54 175.117C213.312 174.922 212.057 174.994 210.858 175.328C209.658 175.661 208.541 176.25 207.581 177.054C207.278 177.31 206.992 177.587 206.728 177.884L172.041 172.736L170.11 146.145C169.963 144.105 169.026 142.208 167.507 140.872C165.987 139.536 164.009 138.87 162.008 139.021C160.007 139.172 158.147 140.127 156.836 141.676C155.526 143.225 154.873 145.241 155.021 147.281C155.024 147.328 155.028 147.376 155.032 147.423L158.413 184.735L158.43 184.818C158.87 186.253 159.752 187.504 160.945 188.387C162.137 189.27 163.578 189.737 165.052 189.719L205.851 189.001C206.009 189.248 206.18 189.486 206.362 189.714C207.152 190.693 208.135 191.492 209.248 192.057C210.361 192.622 211.578 192.941 212.821 192.992C214.063 193.044 215.302 192.828 216.457 192.358C217.611 191.887 218.655 191.173 219.52 190.263C219.696 190.08 219.862 189.89 220.019 189.695C221.195 188.218 221.884 186.401 221.987 184.503C222.089 182.604 221.601 180.721 220.592 179.122Z"
            fill="#FFB7B7"
          />
          <path
            d="M151.001 402L160.487 401.999L165 363L151 363.001L151.001 402Z"
            fill="#FFB7B7"
          />
          <path
            d="M148.001 411L180 410.999V410.59C180 407.251 178.687 404.049 176.352 401.688C174.016 399.327 170.848 398 167.545 398H167.544L148 398.001L148.001 411Z"
            fill="#2F2E41"
          />
          <path
            d="M81 392.832L90.6723 396L108 361.676L93.7238 357L81 392.832Z"
            fill="#FFB7B7"
          />
          <path
            d="M76 400.9L106.205 411L106.335 410.625C107.398 407.569 107.18 404.223 105.727 401.324C104.274 398.426 101.707 396.211 98.5889 395.169L98.5881 395.168L80.14 389L76 400.9Z"
            fill="#2F2E41"
          />
          <path
            d="M139.887 67.2575C139.887 67.2575 149.66 63.9793 155.943 77.0921C162.226 90.2049 172 104.629 172 104.629L166.415 105.94C166.415 105.94 165.019 96.7613 161.528 95.45L162.924 107.251C162.924 107.251 121.038 121.02 102.189 105.94L102.887 101.351C102.887 101.351 100.094 102.006 100.094 105.94L98 103.973C98 103.973 100.094 100.039 106.377 94.7944C110.501 91.3517 111.918 84.8021 112.405 80.7071C112.792 77.2403 114.255 73.9885 116.584 71.4237C120.76 66.8791 128.368 62.0488 139.887 67.2575Z"
            fill="#2F2E41"
          />
          <path
            d="M136 113C126.059 113 118 104.941 118 95C118 85.0589 126.059 77 136 77C145.941 77 154 85.0589 154 95C154 104.941 145.941 113 136 113Z"
            fill="#FFB7B7"
          />
          <path
            d="M159.889 128.097L163.222 127C163.222 127 169.889 129.742 169.889 134.677C169.889 139.613 171 159.355 171 159.355L156 161L159.889 128.097Z"
            fill="#CBCBCB"
          />
          <path
            d="M101.754 235.113C103.091 233.594 103.845 231.639 103.88 229.603C103.916 227.568 103.229 225.587 101.946 224.022L110.992 147.188C111.08 145.376 110.456 143.603 109.257 142.257C108.058 140.911 106.381 140.102 104.595 140.009C102.809 139.916 101.059 140.545 99.7295 141.759C98.4002 142.972 97.5999 144.672 97.5044 146.483C97.5031 146.508 97.502 146.533 97.501 146.558L89.4087 223.474C89.1153 223.772 88.8449 224.093 88.5999 224.434C87.9508 225.344 87.4849 226.375 87.2287 227.468C86.9725 228.561 86.9311 229.695 87.1068 230.804C87.2825 231.913 87.6719 232.977 88.2527 233.933C88.8336 234.89 89.5945 235.721 90.4921 236.379C90.5851 236.447 90.6795 236.514 90.7752 236.578C91.8144 237.275 92.9929 237.731 94.2262 237.912C95.4596 238.093 96.7171 237.994 97.9086 237.624C99.3963 237.167 100.728 236.297 101.754 235.113Z"
            fill="#FFB7B7"
          />
          <path
            d="M110 159L95 157.355C95 157.355 96.1111 137.613 96.1111 132.677C96.1111 127.742 102.778 125 102.778 125L106.111 126.097L110 159Z"
            fill="#CBCBCB"
          />
          <path
            d="M158.257 186.01C158.257 186.01 170.901 209.037 170.901 236.965C170.901 264.893 172 393.032 172 393.032C172 393.032 155.509 400.698 145.614 391.389L136.819 249.56L102.187 388.651C102.187 388.651 85.6959 391.937 78 386.461L92.8421 289.535C92.8421 289.535 98.8889 198.633 115.38 192.061C131.871 185.49 158.257 186.01 158.257 186.01Z"
            fill="#2F2E41"
          />
          <path
            d="M155.347 95C148.938 90.4828 143.751 85.28 140.32 79.091C140.32 79.091 128.56 91.8182 121.373 92.4545C114.186 93.0909 120.719 77.1819 120.719 77.1819L133.786 74L146.2 75.2727L156 81.6364L155.347 95Z"
            fill="#2F2E41"
          />
          <path
            d="M118.308 122.03C118.308 122.03 117.795 121.754 148.46 122.876L161.294 126.428L163 126.9C163 126.9 161.385 159.368 157.077 165.32C152.769 171.273 153.846 174.519 154.923 175.061C156 175.602 158.692 174.519 157.077 177.225C155.462 179.931 153.308 178.307 155.462 179.931C157.615 181.554 158.692 187.506 158.692 187.506L111.308 194C111.308 194 109.692 172.896 105.385 162.074C101.077 151.251 100 146.922 100 146.922L103.231 125.277L118.308 122.03Z"
            fill="#CBCBCB"
          />
        </g>
        <defs>
